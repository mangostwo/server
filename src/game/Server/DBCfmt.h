...
const char CharStartOutfitEntryfmt[] = "dbbbbiiiiiiiiiiiiiiiiiiiiiiiixxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
...
const char CurrencyCategoryfmt[] = "nissssssssssssssssx";
...
const char HolidayNamesfmt[] = "nxxxxxxxxxxxxxxxxx";
const char Itemfmt[] = "niiiiiii";
const char ItemBagFamilyfmt[] = "nxxxxxxxxxxxxxxxxx";
const char ItemClassfmt[] = "nxxssssssssssssssssx";
const char ItemDisplayTemplateEntryfmt[] = "nxxxxxxxxxxxxxxxxxxxxxxxx";
...
const char LfgDungeonsEntryfmt[] = "nssssssssssssssssxiiiiiiiiixxiiixxxxxxxxxxxxxxxxx";
