...
void InitializeOpcodes()
{
    ...
    OPCODE(CMSG_WORLD_TELEPORT,                            STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::WorldTeleportHandler);
    ...
    OPCODE(CMSG_CREATEGAMEOBJECT,                          STATUS_LOGGEDIN, PROCESS_THREADSAFE,   &WorldSession::CreateGameObjectHandler);
    ...
    OPCODE(CMSG_CHEAT_SETMONEY,                            STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::SetMoneyHandler);
    OPCODE(CMSG_LEVEL_CHEAT,                               STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::LevelCheatHandler);
    ...
    OPCODE(CMSG_GM_RESURRECT,                              STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::GmResurrectHandler);
    ...
    OPCODE(CMSG_LFG_GET_STATUS,                            STATUS_LOGGEDIN, PROCESS_THREADSAFE,   &WorldSession::HandleLfgGetStatus);
    ...
    OPCODE(CMSG_LFG_PROPOSAL_RESPONSE,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgProposalResponse);
    ...
    OPCODE(CMSG_LFG_SET_ROLES,                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgSetRoles);
    OPCODE(CMSG_LFG_SET_NEEDS,                             STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    OPCODE(CMSG_LFG_BOOT_PLAYER_VOTE,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgBootVote);
    OPCODE(SMSG_LFG_BOOT_PLAYER,                           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(CMSG_LFG_GET_PLAYER_INFO,                       STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgGetPlayerInfo);
    OPCODE(SMSG_LFG_PLAYER_INFO,                           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(CMSG_LFG_TELEPORT,                              STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgTeleportRequest);
    OPCODE(CMSG_LFG_GET_PARTY_INFO,                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgGetPartyInfo);
