...
OpcodeHandler opcodeTable[NUM_MSG_TYPES] =
{
    ...
    /*0x008*/ { "CMSG_WORLD_TELEPORT",                          STATUS_LOGGEDIN, PROCESS_THREADSAFE,   &WorldSession::WorldportHandler                },
    /*0x009*/ { "CMSG_TELEPORT_TO_UNIT",                        STATUS_LOGGEDIN, PROCESS_THREADSAFE,   &WorldSession::TeleportCheatHandler            },
    ...
    /*0x00F*/ { "CMSG_RECHARGE",                                STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::RechargeHandler				  },
    /*0x010*/ { "CMSG_LEARN_SPELL",                             STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::LearnSpellHandler               },
    /*0x011*/ { "CMSG_CREATEMONSTER",                           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::CreateMonsterHandler            },
    /*0x012*/ { "CMSG_DESTROYMONSTER",                          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::DestroyMonsterHandler           },
    /*0x013*/ { "CMSG_CREATEITEM",                              STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::CreateItemHandler               },
    ...
    /*0x021*/ { "CMSG_BEASTMASTER",                             STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::BeastmasterHandler              },
    /*0x022*/ { "CMSG_GODMODE",                                 STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::GodmodeHandler                  },
    /*0x023*/ { "SMSG_GODMODE",                                 STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               },
    /*0x024*/ { "CMSG_CHEAT_SETMONEY",                          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::SetMoneyCheatHandler            },
    /*0x025*/ { "CMSG_LEVEL_CHEAT",                             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::LevelCheatHandler               },
    ...
    /*0x02C*/ { "CMSG_CLEAR_QUEST",                             STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::OnClearQuestCheat               },
    ...
    /*0x04B*/ { "CMSG_LOGOUT_REQUEST",                          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLogoutRequest       },
    ...
    /*0x0C6*/ { "MSG_MOVE_TELEPORT_CHEAT",                      STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::TeleportCheatHandler            },
    ...
    /*0x0CC*/ { "MSG_MOVE_SET_RUN_SPEED_CHEAT",                 STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::MoveRunSpeedCheatHandler        },
    ...
    /*0x0D2*/ { "MSG_MOVE_SET_SWIM_SPEED_CHEAT",                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::MoveSwimSpeedCheatHandler       },
    ...
    /*0x204*/ { "CMSG_DECHARGE",                                STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::DechargeHandler				  },
    ...
    /*0x20F*/ { "CMSG_GM_TEACH",                                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::GMTeachHandler                  },
    ...
    /*0x2E5*/ { "CMSG_GM_UNTEACH",                              STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::GMTeachHandler                  },
    ...
    /*0x36C*/ { "CMSG_LFG_BOOT_PLAYER_VOTE",                    STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgBootVote               },
    /*0x36D*/ { "SMSG_LFG_BOOT_PLAYER",                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               },
    /*0x36E*/ { "CMSG_LFG_GET_PLAYER_INFO",                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgGetPlayerInfo          },
    /*0x36F*/ { "SMSG_LFG_PLAYER_INFO",                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               },
    /*0x370*/ { "CMSG_LFG_TELEPORT",                            STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgTeleportRequest        },
    /*0x371*/ { "CMSG_LFG_GET_PARTY_INFO",                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgGetPartyInfo           },
