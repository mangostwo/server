...
//     python .ai_tools/bake_cinematic_routes_two.py --out <this file>
//
// World-space camera routes for the ten Wrath starting-race intro cinematics
// plus the Death Knight class intro. Derived offline from WotLK 3.3.5a client
// data: CinematicCamera.dbc provides a world origin and facing per cinematic;
// the referenced camera-only M2 model (MD20 v264) provides the flyby as
// keyframed position/target tracks relative to the camera base vector.
...
// Each race route's final keyframe lands at that race's player spawn point
// (verified against playercreateinfo, 5.8-12.4 yd). The Death Knight camera
// ends ~41-44 yd from the Ebon Hold spawns by design.
...
static const CinematicFlyoverKeyframe s_nightelfKeyframes[] = {
    { 0, 9693.22f, 1041.14f, 1393.94f, 4.2989f },
    { 10034, 9691.12f, 1019.42f, 1350.81f, 5.3342f },
    { 16967, 9716.12f, 982.35f, 1318.08f, 5.9063f },
    { 19200, 9753.58f, 959.94f, 1319.51f, 6.1623f },
    { 21267, 9782.41f, 953.20f, 1320.45f, 0.1629f },
    { 23700, 9811.59f, 957.13f, 1318.86f, 0.2258f },
    { 25300, 9841.09f, 963.53f, 1321.16f, 5.7182f },
    { 29334, 9874.11f, 878.63f, 1328.70f, 4.8474f },
    { 31134, 9879.71f, 807.91f, 1329.75f, 5.1920f },
    { 35134, 9940.37f, 712.05f, 1346.75f, 6.1709f },
    { 39634, 10014.92f, 684.91f, 1366.94f, 0.0707f },
    { 46667, 10129.80f, 696.27f, 1376.56f, 0.0180f },
    { 49600, 10171.91f, 695.51f, 1373.12f, 0.0452f },
    { 51200, 10204.61f, 696.87f, 1371.61f, 0.1603f },
    { 57067, 10290.99f, 680.87f, 1377.97f, 0.5911f },
    { 65400, 10447.70f, 745.10f, 1413.47f, 0.7906f },
    { 66267, 10474.13f, 746.54f, 1412.25f, 1.2065f },
    { 67134, 10500.47f, 749.50f, 1410.34f, 1.8142f },
    { 68067, 10521.71f, 758.30f, 1408.37f, 2.1291f },
    { 68934, 10536.11f, 769.94f, 1405.73f, 2.2685f },
    { 71034, 10545.04f, 809.58f, 1393.81f, 2.5289f },
    { 74667, 10519.78f, 856.94f, 1376.42f, 3.0315f },
    { 77367, 10470.49f, 864.40f, 1366.97f, 3.2788f },
    { 81600, 10411.79f, 857.43f, 1360.77f, 3.4541f },
    { 84867, 10384.59f, 859.39f, 1356.52f, 3.7031f },
    { 89934, 10329.66f, 857.95f, 1343.87f, 4.1234f },
    { 91234, 10320.73f, 853.79f, 1340.49f, 4.3748f },
    { 92667, 10313.06f, 849.07f, 1337.10f, 4.6489f },
    { 93700, 10309.04f, 846.16f, 1335.05f, 4.8525f },
    { 94767, 10306.58f, 843.96f, 1333.48f, 5.0684f },
    { 96867, 10305.52f, 840.74f, 1331.45f, 5.3677f },
    { 102000, 10306.38f, 835.08f, 1328.14f, 5.6178f },
};
...
// Gnome (race 7, sequence 101, cinematic 162, map 0)
...
static const CinematicFlyoverRoute s_gnomeRoute = {
    ...
    162,   // cameraId (CinematicCamera.dbc ID)
    RACE_GNOME,  // raceId
    0,  // classId
    0,     // mapId (Eastern Kingdoms)
    76667, // durationMs
...
// Troll (race 8, sequence 121, cinematic 182, map 1)
...
static const CinematicFlyoverRoute s_trollRoute = {
    ...
    182,   // cameraId (CinematicCamera.dbc ID)
    RACE_TROLL,  // raceId
    0,  // classId
    1,     // mapId (Kalimdor)
    57767, // durationMs
...
static const CinematicFlyoverKeyframe s_draeneiKeyframes[] = {
    { 0, -4140.28f, -11930.50f, 153.75f, 0.8293f },
...
static const CinematicFlyoverKeyframe s_deathknightKeyframes[] = {
    { 0, 2299.51f, -5343.05f, 97.37f, 5.2907f },
    ...
    { 28933, 2328.97f, -5681.23f, 387.52f, 0.5876f },
    { 29400, 2330.58f, -5680.14f, 387.52f, 0.5877f },
    { 29967, 2333.44f, -5678.22f, 387.52f, 0.5877f },
    { 33633, 2403.22f, -5631.15f, 387.52f, 0.5792f },
    { 34033, 2427.47f, -5614.79f, 429.37f, 0.5869f },
    { 35233, 2431.08f, -5615.28f, 469.41f, 0.4882f },
    { 36833, 2417.36f, -5626.62f, 482.30f, 0.3439f },
    { 37700, 2297.16f, -5697.56f, 489.09f, 0.5442f },
    { 40600, 2287.31f, -5694.06f, 469.11f, 0.4486f },
    { 48833, 2321.52f, -5686.30f, 434.29f, 0.5659f },
};
