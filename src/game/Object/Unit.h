...
enum UnitFlags
{
    UNIT_FLAG_UNKILLABLE			= 0x00000001,			// Prevents all damage (god)
    ...
    UNIT_FLAG_BEASTMASTER			= 0x00000080,           // Friendly to all (the usual state on the "blue" server)
