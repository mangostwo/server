...
DELETE FROM scripted_event WHERE id IN (9735,20907,20964,21030,21031,21032,21033,21045,21605,21606,21620);
INSERT INTO scripted_event VALUES
...
(-1000760,'There is but one duty that remains\85',0,0,0,1,'SAY_ANACHRONOS_EPILOGUE_2'),
...
(-1000770,'And now you know all that there is to know, mortal\85',0,0,0,0,'SAY_ANACHRONOS_EPILOGUE_8'),
