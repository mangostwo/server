      ...
      case ${OS} in
        "LinuxMint")
          case ${VER} in
            ...
            "betsy")
              ...
              su -c "aptitude -y install build-essential linux-headers-$(uname -r) autoconf automake cmake libbz2-dev libssl-dev libmysqlclient-dev libtool zliblg-dev" root
              ;;
            *)
              OS_VER=0
              ;;
        ...
        "RedHatEntrepriseServer")
          case ${VER} in
            "santiago")
              # Red Hat 6.x
              su -c "yum -y install curl build-essential linux-headers-$(uname -r) autoconf automake cmake libbz2-dev libssl-dev libmysqlclient-dev libtool zliblg-dev" root
              ;;
            "maipo")
              # Red Hat 7.x
              su -c "yum -y install curl build-essential linux-headers-$(uname -r) autoconf automake cmake libbz2-dev libssl-dev libmysqlclient-dev libtool zliblg-dev" root
